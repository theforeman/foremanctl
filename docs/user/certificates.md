...
After creating the bundle, it prints ready-to-run `scp` and `foremanctl deploy-proxy` commands using the supplied proxy hostname and the detected Foreman server FQDN.
